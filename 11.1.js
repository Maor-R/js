...
const getVideoInfo = (arr) => {
    let retArr =[] ;
    arr.forEach(element => { 
        retArr.push( {id: element.id, name: element.title});
    });
    return retArr;
}

const getVideoInfoWithMap = (arr) => {
...
//test
console.log(getVideoInfo(newReleases));
console.log((getVideoInfoWithMap(newReleases)));
