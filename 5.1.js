...
//Test
countryToLiveIn("hebrew", false, 9300000, "Israel");
countryToLiveIn("english", false, 26200000, "Australia");
countryToLiveIn("french", false, 68000000, "France");
countryToLiveIn("finnish", true, 5500000, "Finland");
